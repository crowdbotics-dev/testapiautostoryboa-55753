...
## Project Structure
    ...
    ├── testapiautostoryboa_55753  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_55753`
...
2. Clone this repo and `cd testapiautostoryboa_55753`
